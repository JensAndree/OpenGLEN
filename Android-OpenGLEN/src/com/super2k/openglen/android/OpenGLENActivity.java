...
//            mOpenGLENThread.start();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (mOpenGLENThread!=null) {
            return mOpenGLENThread.onKeyDown(keyCode, event);
        }
        return false;
    }
    ...
    /**
     * Returns true if OpenGLEN has started.
     * @return True if OpenGLEN has started, false otherwise.
     */
    public boolean hasStarted() {
        if (mOpenGLENThread == null) {
            throw new IllegalArgumentException("OpenGLENThread is null, wrong OpenGLENActivity");
        }
        return mOpenGLENThread.isInitialized();
    }
